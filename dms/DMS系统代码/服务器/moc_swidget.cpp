...
**
** Created: Tue Jul 12 15:40:42 2016
...
static const char qt_meta_stringdata_swidget[] = {
    "swidget\0\0beLogs(MLogRec)\0on_start_clicked()\0"
    "on_table_select_clicked()\0on_send(MLogRec)\0"
    "on_time()\0"
};
...
void swidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->beLogs((*reinterpret_cast< MLogRec(*)>(_a[1]))); break;
        case 1: _t->on_start_clicked(); break;
        case 2: _t->on_table_select_clicked(); break;
        case 3: _t->on_send((*reinterpret_cast< MLogRec(*)>(_a[1]))); break;
        case 4: _t->on_time(); break;
        default: ;
        }
    }
}
...
const QMetaObject swidget::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_swidget,
...
// SIGNAL 0
void swidget::beLogs(MLogRec _t1)
{
